...
<body class="bg-gray-900 text-green-400 min-h-screen flex flex-col">
            ...
            <ul class="flex space-x-6">
                <?php 
                    if (isset($_SESSION['user_id'])) {
                        ...
                        echo "<li><a href='leaderboard.php' class='hover:text-yellow-400 transition'>Leaderboard</a></li>";
                    } else {
                        echo "<li><a href='login.php' class='hover:text-yellow-400 transition'>Login</a></li>";
                    }
                    if (isset($_SESSION['role']) && $_SESSION['role'] != 'Support') {
                        echo "<li><a href='contact.php' class='hover:text-yellow-400 transition'>Contact</a></li>";
                    }
                ?>
    ...
    <div class="relative flex-grow">
        ...
        <div class="relative container mx-auto px-4 py-24 text-center">
            ...
            <a href="#labs" class="inline-block bg-yellow-400 text-black px-8 py-3 rounded-lg hover:bg-yellow-500 transition">
                Explore Labs
            </a>
        </div>
    </div>
