...
<body class="bg-zinc-900 min-h-screen text-gray-200">
    <!-- Navigation Bar -->
    ...
    <div class="flex items-center justify-center p-4 min-h-[calc(100vh-64px)]">
        <div class="bg-zinc-800 shadow-2xl rounded-lg w-full max-w-md p-8 border border-zinc-700">
            ...
            <div class="flex justify-between mt-6">
                <a 
                    href="user_managment.php" 
                    class="px-6 py-2.5 bg-emerald-600 text-white rounded-md hover:bg-emerald-700 transition-colors focus:outline-none focus:ring-2 focus:ring-2 focus:ring-opacity-50 font-semibold"
                >
                    Back
                </a>
                <button 
