            ...
            if ($_SERVER['REQUEST_METHOD'] === 'POST') 
            {
                ...
                elseif($_POST['action'] === 'Edit')
                {
                    ...
                    try
                    {
                        ...
                        description = :description, approved = :approve , admin_id =:aid WHERE lab_id = :labId";
                    ...
                    $stmt->execute();
                    echo "Lab details updated successfully!";
                    $sql2="SELECT * From labs where lab_id = :Lid ";
                    $stat2=$pdo->prepare($sql2);
...
<body class="bg-gray-900 min-h-screen flex items-center justify-center p-4 text-gray-200 relative overflow-hidden">
            ...
            <?php if($lab){?>
                ...
                <div class="flex justify-between mt-6">
                    <button type="submit" name="action" value="Back" 
                            class="px-4 py-2 bg-gray-600 text-gray-200 rounded-md hover:bg-gray-700 transition-colors">
                        Back
                    </button>
