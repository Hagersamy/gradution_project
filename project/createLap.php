...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if(strlen($flag) > 64) {
        die("Lab flag must be in 64 chars!");
    }
    ...
    if ($fileExtension !== 'apk') {
        die("Only .apk files are allowed.");
    }
...
<head>
    ...
    <title>Create My Lab</title>
    <script src="https://cdn.tailwindcss.com"></script>
</head>
<body class="bg-gray-900 min-h-screen flex items-center justify-center px-4 py-8 text-gray-200">
